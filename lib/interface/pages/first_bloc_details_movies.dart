                              ...
                              child: TabBarView(
                                children: <Widget>[
                                  SecondBlocDetailsMoviesSynopsis(
                                    description: state.movieDescr.movieDModel
                                        .description,
                                  ),
                                  ...
                                  SecondBlocDetailsMoviesInfos(
                                    ...
                                    studios: state.movieDescr.movieDModel
                                        .studios,
                                    ...
                                    writers: state.movieDescr.movieDModel
                                        .writers,
                                    total_revenue:
                                    state.movieDescr.movieDModel.total_revenue,
                                  ),
                                ],
                              ),
                            ),
