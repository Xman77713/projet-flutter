...
class _ComicVineAPI implements ComicVineAPI {
  ...
  Future<OFFServerResponseSerieDescr> getSerieDescr(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<OFFServerResponseSerieDescr>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<OFFServerResponseMovieDescr> getMovieDescr(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<OFFServerResponseMovieDescr>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<OFFServerResponseIssueDescr> getIssueDescr(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<OFFServerResponseIssueDescr>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<OFFServerResponsePersonDescr> getPersonDescr(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<OFFServerResponsePersonDescr>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<OFFServerResponseCharacterDescr> getCharacterDescr(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<OFFServerResponseCharacterDescr>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
